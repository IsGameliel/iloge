...
<nav class="fixed top-0 w-full z-50 bg-[#131313]/60 backdrop-blur-[30px] shadow-[0_40px_40px_-10px_rgba(229,226,225,0.05)] border-b border-white/5">
    <div class="relative flex justify-between items-center px-6 md:px-12 py-6 max-w-[1920px] mx-auto">
        <div class="text-2xl font-black tracking-tighter text-[#e5e2e1] uppercase">ILOGE</div>
        <div class="hidden xl:flex items-center space-x-6">
            <a class="font-['Manrope'] tracking-tighter uppercase font-bold text-[#e5e2e1] opacity-70 hover:opacity-100 hover:text-[#f1cc19] transition-all duration-300" href="#">Home</a>
            <div class="relative group">
                <button class="font-['Manrope'] tracking-tighter uppercase font-bold text-[#e5e2e1] opacity-70 hover:opacity-100 hover:text-[#f1cc19] transition-all duration-300 inline-flex items-center gap-1">
                    About
                    <span class="material-symbols-outlined text-base">expand_more</span>
                </button>
                <div class="absolute left-0 top-full pt-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                    <div class="min-w-48 bg-[#131313]/95 backdrop-blur-2xl border border-white/10 rounded-lg shadow-2xl py-3">
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="{{ url('/speaker') }}">Speaker</a>
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="{{ url('/investor') }}">Investor</a>
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="{{ url('/leader') }}">Leader</a>
                    </div>
                </div>
            </div>
            <a class="font-['Manrope'] tracking-tighter uppercase font-bold text-[#e5e2e1] opacity-70 hover:opacity-100 hover:text-[#f1cc19] transition-all duration-300" href="{{ url('/pressroom') }}">Press Room</a>
            <div class="relative group">
                <button class="font-['Manrope'] tracking-tighter uppercase font-bold text-[#e5e2e1] opacity-70 hover:opacity-100 hover:text-[#f1cc19] transition-all duration-300 inline-flex items-center gap-1">
                    Diary of Iloge
                    <span class="material-symbols-outlined text-base">expand_more</span>
                ...
                <div class="absolute left-0 top-full pt-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                    <div class="min-w-56 bg-[#131313]/95 backdrop-blur-2xl border border-white/10 rounded-lg shadow-2xl py-3">
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="{{ url('/podcast') }}">Podcast</a>
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="#">Blog</a>
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="#">Team</a>
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="#">Gallery</a>
                        <a class="block px-5 py-3 font-['Manrope'] text-sm tracking-widest uppercase font-bold text-[#e5e2e1]/70 hover:text-[#f1cc19] hover:bg-white/5 transition-all" href="#">Testimonials</a>
                    </div>
                </div>
            </div>
            <a class="font-['Manrope'] tracking-tighter uppercase font-bold text-[#e5e2e1] opacity-70 hover:opacity-100 hover:text-[#f1cc19] transition-all duration-300" href="#">Shop</a>
            <a class="font-['Manrope'] tracking-tighter uppercase font-bold text-[#e5e2e1] opacity-70 hover:opacity-100 hover:text-[#f1cc19] transition-all duration-300" href="#">Contact</a>
        </div>
        <button class="liquid-gold text-on-primary font-headline font-bold px-5 md:px-8 py-3 rounded-md text-sm uppercase tracking-widest active:scale-95 transition-transform">
            Masterclass
        </button>
        <details class="xl:hidden">
            <summary class="list-none cursor-pointer flex h-11 w-11 items-center justify-center rounded-md border border-white/10 bg-white/5 text-on-surface hover:text-primary hover:bg-white/10 transition-all [&::-webkit-details-marker]:hidden">
            ...
            <div class="absolute right-6 top-full mt-3 w-[min(22rem,calc(100vw-3rem))] bg-[#131313]/95 backdrop-blur-2xl border border-white/10 rounded-lg shadow-2xl p-5">
                <div class="flex flex-col gap-1">
                    <a class="font-['Manrope'] uppercase font-bold tracking-widest text-sm text-[#e5e2e1]/80 hover:text-[#f1cc19] py-3 transition-colors" href="#">Home</a>
                    <details class="border-t border-white/5 py-2">
                        <summary class="list-none cursor-pointer flex items-center justify-between font-['Manrope'] uppercase font-bold tracking-widest text-sm text-[#e5e2e1]/80 hover:text-[#f1cc19] py-3 [&::-webkit-details-marker]:hidden">
                            About
                            <span class="material-symbols-outlined text-base">expand_more</span>
                        </summary>
                        <div class="flex flex-col pl-4 pb-2">
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="{{ url('/speaker') }}">Speaker</a>
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="{{ url('/investor') }}">Investor</a>
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="{{ url('/leader') }}">Leader</a>
                        </div>
                    </details>
                    <a class="font-['Manrope'] uppercase font-bold tracking-widest text-sm text-[#e5e2e1]/80 hover:text-[#f1cc19] py-3 border-t border-white/5 transition-colors" href="{{ url('/pressroom') }}">Press Room</a>
                    <details class="border-t border-white/5 py-2">
                        <summary class="list-none cursor-pointer flex items-center justify-between font-['Manrope'] uppercase font-bold tracking-widest text-sm text-[#e5e2e1]/80 hover:text-[#f1cc19] py-3 [&::-webkit-details-marker]:hidden">
                            Diary of Iloge
                            <span class="material-symbols-outlined text-base">expand_more</span>
                        ...
                        <div class="flex flex-col pl-4 pb-2">
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="{{ url('/podcast') }}">Podcast</a>
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="#">Blog</a>
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="#">Team</a>
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="#">Gallery</a>
                            <a class="py-2 text-xs uppercase tracking-widest text-[#e5e2e1]/60 hover:text-[#f1cc19]" href="#">Testimonials</a>
                        </div>
                    </details>
                    <a class="font-['Manrope'] uppercase font-bold tracking-widest text-sm text-[#e5e2e1]/80 hover:text-[#f1cc19] py-3 border-t border-white/5 transition-colors" href="#">Shop</a>
                    <a class="font-['Manrope'] uppercase font-bold tracking-widest text-sm text-[#e5e2e1]/80 hover:text-[#f1cc19] py-3 border-t border-white/5 transition-colors" href="#">Contact</a>
                </div>
            </div>
        </details>
    </div>
...
<footer class="bg-[#0e0e0e] w-full py-12">
    <div class="flex flex-col md:flex-row justify-between items-center px-6 md:px-12 border-t border-[#4d4635]/15 pt-12 max-w-[1920px] mx-auto">
        ...
        <div class="flex flex-wrap justify-center gap-8 mb-8 md:mb-0">
            ...
            <a class="font-['Inter'] text-xs tracking-widest uppercase text-[#e5e2e1] opacity-40 hover:text-[#f1cc19] hover:opacity-100 transition-opacity" href="#">Contact</a>
        </div>
        <div class="font-['Inter'] text-xs tracking-widest uppercase text-[#e5e2e1] opacity-40 text-center">
            © 2024 THE ARCHITECT OF SHADOWS. ALL RIGHTS RESERVED.
        </div>
    </div>
</footer>
</body>
