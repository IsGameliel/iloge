...
<nav class="fixed top-0 w-full z-50 bg-neutral-900/60 backdrop-blur-[30px] shadow-[0_40px_40px_-10px_rgba(229,226,225,0.05)]">
    <div class="relative flex justify-between items-center px-6 md:px-12 h-20 w-full">
        <a class="text-2xl font-bold tracking-tighter text-[#e5e2e1] font-headline" href="{{ url('/') }}">ILOGE</a>
        <div class="hidden xl:flex items-center space-x-10 font-headline tracking-tight uppercase text-sm">
            <a class="text-[#e5e2e1]/70 hover:text-[#f1cc19] transition-colors duration-300" href="{{ url('/') }}">Home</a>
            <div class="relative group">
                <button class="text-[#f1cc19] border-b border-[#f1cc19] pb-1 transition-colors duration-300 inline-flex items-center gap-1" type="button">
                    About
    ...
    <div class="flex flex-col md:flex-row justify-between items-start w-full max-w-7xl mx-auto gap-12">
        ...
        <div class="flex flex-col md:items-end gap-12">
            ...
            <div class="font-body text-[10px] uppercase tracking-[0.3em] text-[#e5e2e1]/30">
                &copy; 2024 ILOGE STRATEGIC ADVISORY. ALL RIGHTS RESERVED.
            </div>
        </div>
    </div>
</footer>
